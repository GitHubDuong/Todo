...
export class CategoryService {
  ...
  public getAll(): Observable<TypeData<Category>> {
    return this.httpClient.get<TypeData<Category>>(`${_prefix}/list`);
  }
  ...
  public getListWithType(type: number): Observable<any> {
    const options = {
      params: new HttpParams({ fromObject: { types: type } }),
    };
    const url: string = `${_prefix}/list-with-types`;
