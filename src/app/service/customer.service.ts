...
export class CustomerService {
  ...
  public getChartBirthDay(type: number = 0): Observable<TypeData<any>> {
    return this.httpClient.get(`${_prefix}/chart-birthday-customer?type=${type}`).pipe(
  ...
  public getAllCustomer(searchText: string = '', type: number = 0, customerId: [] = []): Observable<TypeData<Customer>> {
  ...
  getListCustomerWithCodeName() {
    return this.httpClient.get(`${AppConstant.DEFAULT_URLS.API}/Customers/list-code-name`, {}).pipe(
      map((listCustomer: TypeData<Customer>) => {
        return listCustomer;
      }),
    );
  }
  ...
  getFolderPathDownload(f: string, t: string): string {
    var k = environment.serverURL + '/api/ReportDownload/DownloadReportFromFile' + `?filename=${f}&fileType=${t}`;
    return k;
  }

  importExcel(formData, type): Observable<any> {
    return this.httpClient.post(`${_prefix}/import-excel/${type}`, formData).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  getCode(type: number): Observable<any> {
    return this.httpClient.get(`${_prefix}/get-code-customer?type=${type}`).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  createQuoteCustomer(customerId: number, request: any): Observable<any> {
    return this.httpClient.post(`${_prefix}/CreateCustomerQuote/${customerId}`, request).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  reportCustomerQuoteDetail(params: any): Observable<any> {
    return this.httpClient.get(`${_prefix}/ReportCustomerQuoteDetail`, { params }).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  getListCustomerQuoteHistory(params: any): Observable<any> {
    return this.httpClient.post(`${_prefix}/GetListCustomerQuoteHistory`, params).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  getListCustomerQuoteDetail(params: any): Observable<any> {
    return this.httpClient.get(`${_prefix}/GetListCustomerQuoteDetail`, { params }).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  getCustomerDebit(id): Observable<any> {
    return this.httpClient.get(`${_prefix}/get-customer-debit?id=${id}`).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  GetDataBaoGia(customerId: number, customerQuoteId: number): Observable<any> {
    return this.httpClient.get(`${_prefix}/GetDataBaoGia?customerQuoteId=${customerQuoteId}&customerId=${customerId}`).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  public updateAccountantForCustomer(id: any, debit: any) {
    return this.httpClient.post(`${_prefix}/accountant-for-customer/${id}`, debit).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  public updateAccountCustomer(id: any, debit: any) {
    return this.httpClient.post(`${_prefix}/account-customer/${id}`, debit).pipe(
      map((data: any) => {
        return data;
      }),
    );
  ...
  public syncCustomer(type: number): Observable<any> {
    return this.httpClient.post(`${_prefix}/sync-account-customer/${type}`, {});
  }
}
