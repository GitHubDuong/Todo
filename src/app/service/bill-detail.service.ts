...
export class BillDetailService {
  ...
  public getBillDetails(billId: number): Observable<TypeData<BillDetailPrint>> {
  ...
  public getBillDetailAndPromotions(billId: number): Observable<TypeData<BillDetailPrint>> {
    let url: string = `${_prefix}/bill-details-and-promotions/${billId}`;
    return this.httpClient.get(url).pipe(
      map((billDetail: TypeData<BillDetailPrint>) => {
        return billDetail;
      }),
