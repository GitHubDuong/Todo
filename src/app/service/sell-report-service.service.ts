...
export class SellReportServiceService {
  ...
  getProfitBeforeTax(params): Observable<TypeData<ProfitBeforeTax>> {
    return this.httpClient
      .get(`${AppConstant.DEFAULT_URLS.API}/Bills/GetListBaoCaoLoiNhuan`, {
        params,
      })
      .pipe(
  ...
  getOrderProduceProductsById(id) {
    return this.httpClient
      .get(`${AppConstant.DEFAULT_URLS.API}/orderProduceProducts/${id}`, {})
      .pipe(
        map((billDetail: any) => {
          return billDetail;
        }),
  ...
  updateWebsiteOrder(orderId, body){
    return this.httpClient.put(`${AppConstant.DEFAULT_URLS.API}/Order/${orderId}`, body);
  }
  ...
  getCustomerForReportBill(params) {
    return this.httpClient
      .get(`${AppConstant.DEFAULT_URLS.API}/Bills/customer-for-report-bill`, {
        params,
      })
      .pipe(
        map((listCustomer: TypeData<DaylyReport>) => {
  ...
  getSaleDepartmentSalary(params): Observable<any> {
    const url = `${AppConstant.DEFAULT_URLS.API}/BillReports/report`;
    return this.httpClient.get(url, { params });
  }
  
  getChartOfAccountForReportBill(params) {
    return this.httpClient
      .get(`${AppConstant.DEFAULT_URLS.API}/Bills/account-for-report-bill`, {
        params,
      })
      .pipe(
        map((listCustomer: TypeData<DaylyReport>) => {
