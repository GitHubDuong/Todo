...
export class CaseService {
  ...
  public getSelectListArise(param: any): Observable<TypeData<CaseSelectList>> {
    const url: string = this._baseUrl + `/cases/selectlist`;
    return this.httpClient.post(url, param).pipe(
      map((casetmp: TypeData<CaseSelectList>) => {
        return casetmp;
  ...
  public getListDetailsDisplayInsertCase(
    ...
    const url: string = this._baseUrl + `/ChartOfAccount/details/${parentCode}`;
  ...
  public getListChartOfAccountByClassification(
    ...
    let url: string =
      this._baseUrl + `/ChartOfAccount/get-chart-accounts-classification?`;
  ...
  public getListChartOfAccount_ForReportLedger(
    ...
    let url: string =
      this._baseUrl + `/ChartOfAccount/get-chart-accounts-for-ledger-report`;
    if (code && code.length > 0) {
      url += '?code=' + code;
    }
    return this.httpClient.get(url, {}).pipe(
  ...
  public getSelectListWithId(id: string): Observable<TypeData<CaseSelectList>> {
  ...
  public getListLastestExceptGroupCase(): Observable<TypeData<CaseSelectList>> {
    const url: string = this._baseUrl + `/cases/getListLastestExceptGroupCase`;
    return this.httpClient.get(url).pipe(
      map((casetmp: TypeData<CaseSelectList>) => {
        return casetmp;
      }),
