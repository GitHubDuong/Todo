...
export class AppMainComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  isLargeScreen() {
    return (
      window.location.href.includes('/arise') ||
      window.location.href.includes('/order') ||
      window.location.href.includes('/uikit/account-v2') ||
      window.location.href.includes('/uikit/account-v2') ||
      window.location.href.includes('/uikit/account-detail-first-v2') ||
      window.location.href.includes('/uikit/account-detail-second-v2')
    );
  }
  ...
  ngOnInit() {
    ...
    this.configService.isMenuMobile.subscribe((value) => {
