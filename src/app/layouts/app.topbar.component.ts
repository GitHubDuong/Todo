...
export class AppTopBarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    window.addEventListener('resize', (event)=>{
      if (this.appMain.isMobile()){
        document.documentElement.style.fontSize = this.themeConfig.fontMobile + 'px';
      }else{
  ...
  onChangeTheme(showMessage) {
    ...
    params.fontMobile = params.fontMobile?.toString();
    params.dbName = this.authService.dbName;
  ...
  onChangePass() {
    ...
    if (this.registFrm.value.oldPassword === this.registFrm.value.password) {
      this.messageService.add({
        severity: 'error',
        detail: AppUtil.translate(
          this.translateService,
    ...
    if (
      this.registFrm.value.password !== this.registFrm.value.confirmPassword
    ) {
      this.messageService.add({
        severity: 'error',
        detail: AppUtil.translate(
  ...
  getNotificationMessage() {
    this.billService.getNotificationToStaffMessage().subscribe((messages) => {
