...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    document.documentElement.style.fontSize = localStorage.getItem('scale')
      ? localStorage.getItem('scale') + 'px'
      : '14px';
    ...
    AppUtil.initTheme(
      {
        ...
        '--primary-color': theme.textColor
          ? theme.primaryColor
          : 'rgb(42,80,210)',
        '--light-primary-color': theme.textColor
          ? theme.lightPrimaryColor
          : 'rgb(156,170,224)',
        '--invalid-primary-color': theme.textColor
          ? theme.invalidPrimaryColor
          : 'rgb(253,55,106)',
        '--primary-color-text': theme.textColor
