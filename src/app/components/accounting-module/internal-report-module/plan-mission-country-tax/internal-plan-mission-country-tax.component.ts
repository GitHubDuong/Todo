...
@Component({
  selector: 'app-internal-plan-mission-country-tax',
  templateUrl: './plan-mission-country-tax.component.html',
  styles: [``],
})
export class InternalPlanMissionCountryTaxComponent implements OnInit {
  appUtil = AppUtil;
  content: string = '';
  types: any = {};
  showTypes: any = [];
  ...
  ngOnInit(): void {
    ...
    this.showTypes = ['previousYear', 'ledgerReportMaker'];
