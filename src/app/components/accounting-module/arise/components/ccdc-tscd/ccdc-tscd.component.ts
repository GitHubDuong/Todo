  ...
  implements OnInit, OnChanges
{
  ...
  onDeleteAllAccount() {
    ...
    this.assetsFixedService.deleteAssets(requestDataIds).subscribe((res) => {
      this.messageService.add({
        severity: 'success',
  ...
  onUpdateAccount(): void {
    ...
    const request =
      fixedAssetUpdates?.reduce((arr, curr) => {
        arr.push({
          ...curr,
          debitCode: this.fc['debitCode']?.value?.code || curr.debitCode,
          debitDetailCodeFirst:
            this.fc['debitDetailCodeFirst'].value?.code ||
          ...
          creditCode: this.fc['creditCode']?.value?.code || curr.creditCode,
          creditDetailCodeFirst:
            this.fc['creditDetailCodeFirst']?.value?.code ||
