...
@Component({
  selector: 'app-overreach-register-receipt-detail',
  templateUrl: './register-receipt-detail.component.html',
  styles: [``],
})
export class OverreachRegisterReceiptDetailComponent implements OnInit {
  appUtil = AppUtil;
  content: string = '';
  types: any = {};
  showTypes: any = [];
