...
export class AriseCrudTaxComponent implements OnInit {
  ...
  filterDebitDetailCodeFirst(event, index) {
    ...
    var callBack = () => {
      setTimeout(() => {
        const autocompletePanel = this.debitDetailCodeFirstTmpTaxComponents[
          '_results'
  ...
  filterDebitDetailCodeSecond(event, index) {
    ...
    var callBack = () => {
      setTimeout(() => {
        const autocompletePanel = this.debitDetailCodeSecondTmpTaxComponents[
          '_results'
        ][index].el.nativeElement.querySelector('.p-autocomplete-panel');
  ...
  onSelectDebitDetailCodeSecond($event, index) {
    ...
    this.focusInput(this.creditCodeTmpTaxComponents['_results'][index], index);
    this.setFlagCaculate(null, index);
  }
  ...
  filterCreditDetailCodeFirst(event, index) {
    ...
    var callBack = () => {
      setTimeout(() => {
        const autocompletePanel = this.creditDetailCodeFirstTmpTaxComponents[
          '_results'
        ][index].el.nativeElement.querySelector('.p-autocomplete-panel');
  ...
  filterCreditDetailCodeSecond(event, index) {
    ...
    var callBack = () => {
      setTimeout(() => {
        const autocompletePanel = this.creditDetailCodeSecondTmpTaxComponents[
          '_results'
        ][index].el.nativeElement.querySelector('.p-autocomplete-panel');
        if (
          autocompletePanel &&
