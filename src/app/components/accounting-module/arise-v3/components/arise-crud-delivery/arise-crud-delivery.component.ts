...
@Component({
  selector: 'app-arise-crud-delivery',
  templateUrl: './arise-crud-delivery.component.html',
  styleUrls: ['./arise-crud-delivery.component.scss'],
})
export class AriseCrudDeliveryComponent implements OnInit {
