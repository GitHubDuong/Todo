...
export class AriseV3Component implements OnInit {
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    if (
      ...
      !['F8', 'F9', 'F2', 'F4', 'F6', 'F10', 'F7', 'F3'].includes(event.key)
    )
      return;
    ...
    setTimeout(() => {
      switch (event.key) {
        ...
        case 'F10':
          ...
          break;
        case 'F7':
          if (this.ariseCrudV3Component.dataTable?.showAllDocument) return;
  ...
  onAfterAddEditAccountItem() {
    ...
    this.getChartOfAccounts(() => {
      if (this.ariseCrudV3Component.isDebitCodeHas) {
        const code = this.ariseCrudV3Component.fc['debitCode'].value.code;
      ...
      if (this.ariseCrudV3Component.isCreditCodeHas) {
        const code = this.ariseCrudV3Component.fc['creditCode'].value.code;
        const account = _.find(this.chartOfAccounts, { code: code });
        if (!account) {
          return;
        }
  ...
  onAfterAddEditAccountDetailFirstItem() {
    ...
    if (this.ariseCrudV3Component.isDebitDetailCodeFirstHas) {
      const debitCode = this.ariseCrudV3Component.fc['debitCode'].value.code;
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV3Component.fc['debitDetailCodeFirst'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV3Component.setFlagCaculate();
    ...
    if (this.ariseCrudV3Component.isCreditDetailCodeFirstHas) {
      const creditCode = this.ariseCrudV3Component.fc['creditCode'].value.code;
      const id = this.ariseCrudV3Component.fc['debitCode'].value.id;
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV3Component.fc['creditDetailCodeFirst'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV3Component.setFlagCaculate();
  ...
  onAfterAddEditAccountDetailSecondItem() {
    ...
    if (this.ariseCrudV3Component.isDebitDetailCodeSecondHas) {
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV3Component.fc['debitDetailCodeSecond'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV3Component.setFlagCaculate();
    ...
    if (this.ariseCrudV3Component.isCreditDetailCodeSecondHas) {
      ...
      const creditDetailCodeSecondCode =
        this.ariseCrudV3Component.fc['creditDetailCodeSecond'].value.code;
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV3Component.fc['creditDetailCodeSecond'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV3Component.setFlagCaculate();
  ...
  onSaveTaxCode($event) {
    ...
    const invoiceAddress = this.ariseCrudV3Component.fc['invoiceAddress'].value;
  ...
  onSavePayerName($event) {
    ...
    const orginalAddress = this.ariseCrudV3Component.fc['orginalAddress'].value;
    this.payerService
      .create({
        id: 0,
        code: '',
