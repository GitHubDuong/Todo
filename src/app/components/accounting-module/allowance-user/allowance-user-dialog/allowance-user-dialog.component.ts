    ...
    if (this.data.listItem?.length) {
      ...
      this.data.listItem?.map((item) => {
        this.items.push(
          new FormGroup({
            ...
            workingDaysFrom: new FormControl(item.workingDaysFrom),
            workingDaysTo: new FormControl(item.workingDaysTo),
      ...
      this.items.push(
        new FormGroup({
          ...
          workingDaysFrom: new FormControl(),
          workingDaysTo: new FormControl(),
        }),
      );
  }
    ...
    const allowances =
      this.items.value?.reduce((arr, curr) => {
        arr.push({
          ...
          workingDaysFrom: curr.workingDaysFrom,
          workingDaysTo: curr.workingDaysTo,
