...
@Component({
  selector: 'app-arise-list-filter-v4',
  templateUrl: './arise-list-filter-v4.component.html',
  styleUrls: ['./arise-list-filter-v4.component.scss'],
})
export class AriseListFilterV4Component implements OnInit {
      ...
      fileReader.onload = (e) => {
        ...
        result.forEach((element) => {
          importListItem.push({
            ...
            bookDate: AppUtil.convertStringToDate(element['bookDate']),
            orginalVoucherNumber: element['orginalVoucherNumber'] || '',
            ...
            referenceVoucherNumber: element['referenceVoucherNumber'] || '',
            ...
            debitDetailCodeFirst: element['debitDetailCodeFirst'] || '',
            debitDetailCodeSecond: element['debitDetailCodeSecond'] || '',
            creditCode: element['creditCode'] || '',
            creditWarehouse: element['creditWarehouse'] || '',
            creditDetailCodeFirst: element['creditDetailCodeFirst'] || '',
            creditDetailCodeSecond: element['creditDetailCodeSecond'] || '',
            ...
            orginalCurrency: Number(element['orginalCurrency'] || 0),
            debitCodeName: element['debitCodeName'] || '',
            debitDetailCodeFirstName: element['debitDetailCodeFirstName'] || '',
            debitDetailCodeSecondName:
            ...
            creditWarehouseName: element['creditWarehouseName'] || '',
            isInternal: Number(element['isInternal'] == '3. Nội bộ' ? 3 : 1),
        ...
        this.managementAriesExcelService.importExcel(importFileObj).subscribe(
          (res) => {
            if (res) {
              this.messageService.add({
                severity: 'success',
