...
import { AriseCrudV4Component } from './arise-crud-v4/arise-crud-v4.component';
import { AriseListV4Component } from './arise-list-v4/arise-list-v4.component';
...
@Component({
  selector: 'app-arise-v4',
  templateUrl: './arise-v4.component.html',
  styleUrls: ['./arise-v4.component.scss'],
})
export class AriseV4Component implements OnInit {
  @ViewChild('ariseListV2Component')
  ariseListV2Component!: AriseListV4Component;
  @ViewChild('ariseCrudV2Component')
  ariseCrudV2Component!: AriseCrudV4Component;
    ...
    setTimeout(() => {
      switch (event.key) {
        ...
        case 'F10':
          ...
          break;
        case 'F7':
          if (this.ariseCrudV2Component.dataTable?.showAllDocument) return;
  ...
  onAfterAddEditAccountItem() {
    ...
    this.getChartOfAccounts(() => {
      if (this.ariseCrudV2Component.isDebitCodeHas) {
        const code = this.ariseCrudV2Component.fc['debitCode'].value.code;
      ...
      if (this.ariseCrudV2Component.isCreditCodeHas) {
        const code = this.ariseCrudV2Component.fc['creditCode'].value.code;
        const account = _.find(this.chartOfAccounts, { code: code });
        if (!account) {
          return;
        }
  ...
  onAfterAddEditAccountDetailFirstItem() {
    ...
    if (this.ariseCrudV2Component.isDebitDetailCodeFirstHas) {
      const debitCode = this.ariseCrudV2Component.fc['debitCode'].value.code;
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV2Component.fc['debitDetailCodeFirst'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV2Component.setFlagCaculate();
    ...
    if (this.ariseCrudV2Component.isCreditDetailCodeFirstHas) {
      const creditCode = this.ariseCrudV2Component.fc['creditCode'].value.code;
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV2Component.fc['creditDetailCodeFirst'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV2Component.setFlagCaculate();
  ...
  onAfterAddEditAccountDetailSecondItem() {
    ...
    if (this.ariseCrudV2Component.isDebitDetailCodeSecondHas) {
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV2Component.fc['debitDetailCodeSecond'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV2Component.setFlagCaculate();
    ...
    if (this.ariseCrudV2Component.isCreditDetailCodeSecondHas) {
      ...
      const creditDetailCodeSecondCode =
        this.ariseCrudV2Component.fc['creditDetailCodeSecond'].value.code;
      ...
      this.chartOfAccountService
        ...
        .subscribe((res) => {
          if (res.data.length) {
            this.ariseCrudV2Component.fc['creditDetailCodeSecond'].setValue(
              res.data[0],
            );
          }
          this.ariseCrudV2Component.setFlagCaculate();
  ...
  onSelectAccountItem($event) {
    ...
    this.displayCURSAccountDetailSecond = false;
    if (
      this.keyOpenModelAccount == ConfigAriseEnum[ConfigAriseEnum.debitCode]
    ) {
    ...
    // credit
      ...
      this.keyOpenModelAccount == ConfigAriseEnum[ConfigAriseEnum.creditCode]
    ) {
  ...
  onSaveTaxCode($event) {
    ...
    const invoiceAddress = this.ariseCrudV2Component.fc['invoiceAddress'].value;
  ...
  onSavePayerName($event) {
    ...
    const orginalAddress = this.ariseCrudV2Component.fc['orginalAddress'].value;
    this.payerService
      .create({
        id: 0,
        code: '',
  ...
  private buildButtonOtherCommand(dataTable) {
    ...
    if (dataTable?.document.code == 'NK') {
      this.buttonMenus.push({
        ...
        icon: 'pi pi-pencil',
        command: () => {
          this.ariseListV2Component.onPrintF7(dataTable?.document.code);
        },
      });
    } else if (
