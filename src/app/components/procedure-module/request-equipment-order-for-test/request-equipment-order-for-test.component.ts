...
@Component({
  ...
  templateUrl: './request-equipment-order-for-test.component.html',
  styleUrls: ['./request-equipment-order-for-test.component.scss'],
})
export class RequestEquipmentOrderForTestComponent implements OnInit, AfterContentInit {
  showForm = false;
  selectedItem: any;
  loading = false;
  data: any[] = [];
