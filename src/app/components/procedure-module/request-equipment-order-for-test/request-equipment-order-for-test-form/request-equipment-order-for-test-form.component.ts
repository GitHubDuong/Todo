...
@Component({
  selector: 'app-request-equipment-order-for-test-form',
  templateUrl: './request-equipment-order-for-test-form.component.html',
  styleUrls: ['./request-equipment-order-for-test-form.component.scss'],
})
export class RequestEquipmentOrderForTestFormComponent implements OnChanges, OnInit {
