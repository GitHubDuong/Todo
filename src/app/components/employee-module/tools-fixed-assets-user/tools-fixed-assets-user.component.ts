      ...
      fileReader.onload = (e) => {
        ...
        result.forEach((element) => {
          importListItem.push({
            ...
            usedDate: AppUtil.convertStringToDate(element['usedDate']) || '',
            endOfDepreciation:
              AppUtil.convertStringToDate(element['endOfDepreciation']) || '',
            liquidationDate:
              AppUtil.convertStringToDate(element['liquidationDate']) || '',
            totalMonth: Number(element['totalMonth']) || 0,
            depreciationOfOneDay: Number(element['depreciationOfOneDay']) || 0,
            accruedExpense: Number(element['accruedExpense']) || 0,
            totalDayDepreciationOfThisPeriod:
              Number(element['totalDayDepreciationOfThisPeriod']) || 0,
            depreciationOfThisPeriod:
              Number(element['depreciationOfThisPeriod']) || 0,
            carryingAmountOfLiquidationAsset:
              Number(element['carryingAmountOfLiquidationAsset']) || 0,
            carryingAmount: Number(element['carryingAmount']) || 0,
            departmentManager: element['departmentManager'] || '',
            departmentManagerName: element['departmentManagerName'] || '',
            ...
            invoiceDate:
              AppUtil.convertStringToDate(element['invoiceDate']) || '',
        ...
        this.assetsFixedUserService.importExcel(importListItem).subscribe(
          (res) => {
