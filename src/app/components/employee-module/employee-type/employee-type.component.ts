...
export class EmployeeTypeComponent implements OnInit {
  ...
  getEmployeeTypes(event?: any): void {
  ...
  getDetail(ContractTypeId) {
    this.ContractTypeService.getContractTypeDetail(ContractTypeId).subscribe(
  ...
  onDelete(ContractTypeId) {
    ...
    this.confirmationService.confirm({
      message: message,
      accept: () => {
        this.ContractTypeService.deleteContractType(ContractTypeId).subscribe(
          (response: any) => {
            this.getEmployeeTypes();
          },
        );
