...
export class DecideComponent implements OnInit {
  ...
  @ViewChild('decideForm') DecideFormComponent: DecideFormComponent | undefined;
  ...
  getDetail(decide) {
    this.decideService.getDecideDetail(decide.id).subscribe((response: any) => {
  ...
  onDelete(decideId) {
    ...
    this.confirmationService.confirm({
      ...
      message: message,
      accept: () => {
        this.decideService.deleteDecide(decideId).subscribe((response: any) => {
          this.getDecides();
        });
      },
    });
